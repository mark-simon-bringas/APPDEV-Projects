    ...
    return (
        <>
            ...
            <div className="showcase-wrapper">
                ...
                {/* product review page */}
                <div>
                    <h1>Check What our Customers Have to Say</h1>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde cupiditate, incidunt quo asperiores nemo in aliquam molestias maiores, quia ducimus voluptatum iusto nisi architecto blanditiis dolorum dolor hic aut recusandae.
                    </p>
                    <hr />
                </div>
